...
const Page: NextPage = () => {
    return (
        ...
        position="relative"/>
            ...
            <h2><b>ГЕТЕРОТОПИИ СО-ВРЕМЕННОСТИ</b> – картина российского цехового ландшафта в наступившем веке – где разрывы, где связности/ядра/пузыри/облака и как вся картина анимируется – от какого к какому состоянию она движется.</h2>

            <img src="src/components/image/Heterotopia2.jpg"/>
            <br></br>
            <img src="src/components/image/Heterotopia3.jpg"/>
